...
#### <img src="Statistics_Icon.png" style="height:40px; vertical-align: -6px; margin-right: 10px;"> Statistical Modeling
...
#### <img src="Programming_Icon.png" style="height:40px; vertical-align: -6px; margin-right: 10px;"> Programming 
...
#### <img src="Visualization_Icon.png" style="height:40px; vertical-align: -6px; margin-right: 10px;"> Visualization
...
#### <img src="Research_Icon.png" style="height:40px; vertical-align: -6px; margin-right: 10px;"> Research Methods 
...
<p style="text-align: center;">
  <img src="Ian_Whiskey.jpg" style="height:220px; margin-right:20px;">
  <img src="snowboard.jpg" style="height:220px;">
</p>
